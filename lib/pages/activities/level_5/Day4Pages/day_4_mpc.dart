...
class DayFourMultipleChoicePage extends StatefulWidget {
  const DayFourMultipleChoicePage({super.key});
...
class _DayFourMultipleChoicePageState extends State<DayFourMultipleChoicePage> {
  final List<Map<String, dynamic>> questions = [
    {
      'question': '1. Which prediction is based on the title and illustration?',
      'options': [
    ...
    {
      'question': '2. Why does Nick choose a corgi?',
      'options': [
    ...
    {
      'question':
          '4. Why would Nick suggest going to the pet-supply store next?',
      'options': [
    ...
    {
      'question':
          '5. How does the shelter manager probably feel about Nick adopting Tucker?',
      'options': ['worried', 'jealous', 'furious', 'glad'],
      'answer': 'glad',
    },
    {
      'question': '6. What do you think Nick will do when he gets home?',
      'options': [
    ...
    {
      'question': '7. What can readers learn from Nick and his family?',
      'options': [
    ...
    {
      'question': '8. Which text would have a similar theme?',
      'options': [
  ...
  Widget build(BuildContext context) {
    if (finished) {
      return Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Day 4 - Quiz Results'),
        ),
        body: Center(
          child: Padding(
    ...
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: const Text('Day 4 - Multiple Choice'),
      ),
      body: SafeArea(
        child: Column(
          children: [
